...
\begin{frame}{Why ROS 2?}
	\begin{columns}
        ...
        \begin{block}{}
        \textbf{ROS is not an operating system in the traditional sense of process management and scheduling; rather, it provides a structured communications layer above the host operating systems of a heterogenous compute cluster.\footnote{Quigley, M. et al., \textbg{ROS: an open-source Robot Operating System}, ICRA workshop on open source software, 2005}}
        \end{block}
        }
        \only<2>{
